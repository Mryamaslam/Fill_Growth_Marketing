      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-text-light max-w-2xl mx-auto">
            Choose the perfect plan to scale your brand's growth
          </p>
        ...
        >
          <Link href="/packages">
            <motion.button
              className="px-8 py-4 bg-gradient-accent text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all"
